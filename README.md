...
Example invocation:
```
 $ ./aggregate.py --major=4 --minor=18 --output-dir tmp --image-name quay.io/jupierce/test:4.18-aggregate-fbc --push
...
Building catalog image: quay.io/jupierce/test:4.18-aggregate-fbc
...
[2/2] COMMIT quay.io/jupierce/test:4.18-aggregate-fbc
--> a829b8f450e
...
Pushing image: quay.io/jupierce/test:4.18-aggregate-fbc
